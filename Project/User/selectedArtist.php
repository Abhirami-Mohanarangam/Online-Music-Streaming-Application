...
<body>
		...
		<div class="player-box">
			<div class="tarck-thumb-warp">
				<div class="tarck-thumb">
					<img src="images/artists/<?php echo $row['img_path'];?>" alt="">
				</div>
			</div>
		...
		<div class="container-fluid">
			...
			<div class="category-items">
				<div class="row">
					<?php
						$count = 0;
						$query = "CALL getArtistSongs('".$artist_id."');";
						$result = $con->query($query);
							...
							<div class="jp-gui jp-interface">
								<div class="ss-controls">
									<div class="songs-links">
										...
										<a href="choosePlaylist.php?sid=<?php echo $row['id']?>&page=Artist&aid=<?php echo $_GET['aid']?>"><i class="fa fa-plus" style='font-size:36px; color:orange;'></i></a>
									</div>
	...
	<div id="chart">
		<?PHP
			if($count > 1){
				include("config.php");
				$query = "SELECT * FROM songs where songs.id in (select song_id from artists_songs where artist_id = $artist_id)";
