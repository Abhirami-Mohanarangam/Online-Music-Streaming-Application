...
<body>
		...
		<div class="player-box">
			<div class="tarck-thumb-warp">
				<div class="tarck-thumb">
					<img src="images/playlist/<?php echo $_GET['var'];?>.jpg" alt="">
				</div>
			</div>
			<div class="wave-player-warp">
				...
				<a href="playAll.php?pid=<?php echo $_GET['pid']?>" target = "_blank"><button class="btn-primary">Play All</button></a>
                <a href = "deletePlaylist.php?pid=<?php echo $_GET['pid']?>&var=<?php echo $_GET['var']?>"><button class="btn-danger">Delete</button></a>
			</div>
		</div>
	</section>
	<!-- Player section end -->
		...
		<div class="container-fluid">
			...
			<div class="category-items">
				<div class="row">
					<?php
						$count = 0;
						$query = "CALL getPlaylistSongs('".$playlist_id."');";
						$result = $con->query($query);
						...
						<div class="jp-gui jp-interface">
							<div class="ss-controls">
								<div class="songs-links">
                                    ...
                                    <a href="deleteSongFromPlaylist.php?pid=<?php echo $_GET['pid']?>&sid=<?php echo $row['id']?>" onclick = "return confirm('Do you want to delete this?')">
                                        <i class = "glyphicon glyphicon-trash" style='font-size:36px;color:orange;'></i>
                                    </a>
								</div>
	...
	<?php
		if($count > 1){
			include('config.php');
			$query = "select * from songs where id in (select song_id from playlist_songs where playlist_id = 1)";	
