    	...
    	<h2 class="header">Album Record Section</h2>	
        	<div class="form">
            	<table width="650" border="0" cellpadding="1" cellspacing="0" bgcolor="">
                	<tr>
                    	<th class="table">ID</th><th class="table">Album</th><th class="table">Image Path</th><th class="table">Action</th>
                    </tr>
                    <?php
						...
						$dataperpage = mysqli_query($con,"SELECT * FROM albums");
						...
						$sql = mysqli_query($con,"SELECT * from albums ORDER BY id ASC LIMIT $eu, $limit");
                    ...
                    <tr align="center" bgcolor="<?php echo $bgcolor?>">
                        ...
                        <a href="AdminViewSongs.php?id=<?php echo $row['id']?>&page=Albums" class="link">View Songs</a>&nbsp;|&nbsp;
                        <a href="AdminSong.php?id=<?php echo $row['id']?>&page=Albums" class="link">Add Song</a>&nbsp;|&nbsp;
						<a href="AdminEditAlbum.php?id=<?php echo $row['id']?>" class="link">Edit</a>&nbsp;|&nbsp;
						<a href="AdminDeleteAlbum.php?id=<?php echo $row['id']?>" class="link" onclick="return confirm('Do you want to delete this?');">Delete</a></td>
                    </tr>
