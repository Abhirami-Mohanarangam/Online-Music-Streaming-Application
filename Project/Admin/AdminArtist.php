...
<div class="container_wrapper">
    ...
    <div class="sidebar_menu">
    	...
    	<ul>
        	<li><a href="AdminArtist.php"><img src="Templates/list-style.png" height="8"  width="8"/>&nbsp;Add New Artists</a></li>
    ...
    <div class="home_content">
    	<h2 class="header">Add New Artist</h2>	
        <div class="form">
            <form  method="POST" name="myform">
                <div>
                    <label for="Artist">Artist Name</label>
                    <input type="text" name="name"  placeholder="Artist Name" size="39" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="reset" value="Cancel" onclick = "window.location.href = 'AdminArtist.php'" >
                </div>                  
            </form> 
            <?php
                if(isset($_POST['add'])){
                     echo '<script>window.location.href="AdminAddArtist.php?name='.$_POST['name'].'&image='.$_POST['image'].'"</script>';
                }
            ?>
        </div>
    </div>
